  ...
  return (
    <>
      <Carousel  style={contentStyle}>
        <div>
          <img src="https://d-themes.com/react/molla/demo-10/images/home/sliders/slide-1.jpg" height={'400px'} width={'1152px'}/>
          <div class="intro-content">
            ...
            <a class="btn btn-white-primary btn-round" href="/react/molla/demo-10/shop/sidebar/list/"><span>SHOP NOW</span></a>
            </div>
          </div>
        </div>
        <div>
        <img src="https://d-themes.com/react/molla/demo-10/images/home/sliders/slide-3.jpg" height={'400px'} width={'1152px'}/>
          <div class="intro-content">
            <div class="css-sanqhm">
            <h3 class="intro-subtitle text-white">Deals and Promotions</h3>
        ...
        <div>
        <img src="http://res.cloudinary.com/dm0w2qws8/image/upload/v1706200379/rry3semtlkngaf9ktaqw.jpg" height={'400px'} width={'1152px'}/>
          <div class="intro-content">
            <div class="css-sanqhm">
