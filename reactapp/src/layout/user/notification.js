            ...
            <div className="col-md-10 ms-2">
              <span>
                ...
                <span className="text-danger">     
                  <b>{notification.nguoiDung?notification.nguoiDung.ten:notification.hoaDon.tenNguoiNhan}</b> {"   "}
                </span>
                đã đặt đơn hàng
              </span>
              <br></br>
